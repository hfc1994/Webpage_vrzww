...
$(window).scroll(function() {
	...
	// Change this to set the height of your nav bar so it hides properly. If
	// you have a box shadow you may have to adjust this number to be height +
	// shadow distance
	var navBarHeight = 90;
	...
	docHeight = $(document).height(), windowHeight = $(window).height();
